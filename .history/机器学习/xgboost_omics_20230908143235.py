...
param_grid = {'learning_rate': [0.1, 0.3], 'n_estimators': [500], 'max_depth': [10], 'min_child_weight': [1]}



kfold = RepeatedStratifiedKFold(n_splits=5, n_repeats=10)

grid_search = GridSearchCV(model, param_grid, scoring="roc_auc", n_jobs=4, cv=kfold, verbose=1, return_train_score=True)
