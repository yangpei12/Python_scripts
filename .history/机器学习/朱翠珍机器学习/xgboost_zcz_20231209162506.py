...
# 构建pipeline对象
pipe_xgb = make_pipeline(XGBClassifier(random_state=1))

# 设置超参数并使用网络搜索法构建学习器
param_grid = [{'xgbclassifier__learning_rate': [0.01, 0.03, 0.05, 0.07, 0.1], 
               'xgbclassifier__max_depth': [5,10,15], 
               'xgbclassifier__min_child_weight': [1],
               'xgbclassifier__split_loss': [0],
               'xgbclassifier__booster': ['gbtree'],
               'xgbclassifier__n_estimators':[300,400,500]}]
