...
# ========================== 1. 合并共同通路 ==========================
# 设置路径
mRNA_kegg_path = 'rawdata/{0}/KEGG_Enrichment.xlsx'.format(cond)
meta_kegg_path = 'rawdata/{0}/kegg.xlsx'.format(cond)
...
output_name = '{0}/{1}_common_pathway_result.txt'.format('Output', cond)
