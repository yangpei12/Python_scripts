...
mRNA_samples = [x[5:] for x in list(diff_mRNA_exp_matrix)]

# 判断mRNA的样本是否存在与meta中
common_sample = set(mRNA_samples) & set(list(diff_meta_exp))
diff_meta_exp_matrix = diff_meta_exp.loc[:, list(common_sample)]
