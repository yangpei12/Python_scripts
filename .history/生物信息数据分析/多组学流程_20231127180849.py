...
# 差异表达矩阵
diff_mRNA_exp_matrix.to_csv('summary/{0}/Integrative_Analysis/{0}_mRNA_exp_matrix.txt'.format(cond, cond), sep='\t', index=True)
diff_meta_exp_matrix.to_csv('summary/{0}/Integrative_Analysis/{0}_meta_exp_matrix.txt'.format(cond, cond), sep='\t', index=True)
...
# ========================== 3. 相关系数热图 ==========================
# R文件路径
corrcoef_heatmap_cmd = 'Rscript corr_heatmap.R -c {0}'.format(cond)
...
# ========================== 5. O2PLS分析 ============================
# R文件路径
o2pls_analysis_cmd = 'Rscript O2PLS_analysis.R -c {0}'.format(cond)
