...
gs = GridSearchCV(estimator=pipe_xgb, param_grid=param_grid, cv=stratified_kfold, refit=True)
...
svm_best_params = 'Best params are {0}\n'.format(clf.best_params_)
final_result.write(svm_best_params)
