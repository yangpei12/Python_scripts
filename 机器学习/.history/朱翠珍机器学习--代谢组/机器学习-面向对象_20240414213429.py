...
inputData = pd.read_csv('/Users/yangpei/YangPei/after_sale/朱翠珍--机器学习/mRNA/lasso_select_feature_mRNA.txt', sep='\t', header=0)
...
class features_select_algorithm:
    ...
    def lasso_algorithm(self):
        ...
        plt.axis("tight")
        plt.savefig('lasso_path_plot.pdf')
    ...
    def sha(self, best_model, algorithm):
        ...
        for i in range(len(inputData)):
            shap.force_plot(explainer.expected_value, shap_values[0, :], 
                            inputData.iloc[0, :-1], show=False, matplotlib=True).savefig('%s_force_%s.png'%(algorithm, i))
...
# lasso筛选特征
os.chdir('/Users/yangpei/YangPei/after_sale/朱翠珍--机器学习/mRNA/svm')
...
# 逻辑回归
os.chdir('/Users/yangpei/YangPei/after_sale/朱翠珍--机器学习/mRNA/lr')
